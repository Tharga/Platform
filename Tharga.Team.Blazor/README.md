...
- **Team management** - `TeamSelector`, `TeamComponent`, `TeamDialog`, `InviteUserDialog`, `TeamInviteView`. `TeamComponent`'s member list tints the signed-in user's own row and marks it with an icon (language-neutral — no localized text).
