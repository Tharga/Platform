...
- **Team management** - `TeamSelector`, `TeamComponent`, `TeamDialog`, `InviteUserDialog`, `TeamInviteView`. `TeamComponent`'s member list tints the signed-in user's own row and tags it with a **You** chip.
